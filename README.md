...
Landing page of Internsync showing user roles and login options.
...
Student dashboard with active internships and application status.
...
Company dashboard to post new internship opportunities.
...
Company view of received student applications.
...
Admin user management page (add, edit, remove users).
